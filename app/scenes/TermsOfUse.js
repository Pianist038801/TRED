    ...
    return (
      <View style={[styles.main, {paddingTop:paddingTop, paddingBottom:48}]}>
        <View style={[styles.content, {flex:1, paddingHorizontal:0, backgroundColor: "#ffffff"}]}>
          <WebView source={{uri:"https://www.tred.com/terms-of-use-mobile"}} style={{flex:1}} startInLoadingState={true} loading={true} javaScriptEnabled={true} />
        </View>
