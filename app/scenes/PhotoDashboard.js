...
var PhotoDashboard = React.createClass({
  ...
  componentDidMount: function(){
    ...
    return imageService.getImage('dashboard')
      .then((image) => {
        this.setState({
  ...
  onConfirm: function(data) {
    return imageService.addImage('dashboard', data.imageUri, {category: 'interior'})
      .then(() => {
    ...
    return (
      <View style={styles.cameraScene}>
        { this.state.loading ? null : <Camera
          title="DASHBOARD W/ ENGINE ON"
          instructions="Using the orange outline as a guide, turn the engine on and take a photo of the dashboard."
          confirmation="Make sure your pic is centered and in focus. Keep in mind, well photographed cars sell for more."
          overlayImage={require('../../images/overlays/photo-dashboard.png')}
          vinRead={false}
